...
function install_plugin {
  ...
  rm -rf ~/".vim/pack/${VIM_PLUGIN_DIR}/start/${PLUGIN_NAME}"
  git clone --quiet --depth 1 "${PLUGIN_GIT_REPO}" ~/".vim/pack/${VIM_PLUGIN_DIR}/start/${PLUGIN_NAME}"
}
...
VIM_PLUGIN_DIR=gabipetrovay

mkdir -p ~/".vim/pack/${VIM_PLUGIN_DIR}/start"
